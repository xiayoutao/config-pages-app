<template>
<div class="x-richtext richtext" :style="{background: dataForm.background}">
  <div class="richtext-inner" :class="{fullscreen: dataForm.fullscreen}" v-html="dataForm.content || content"></div>
</div>
</template>
